...
private void setupMenuListeners() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 370, 80, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 370, 80, 30));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 370, 80, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/software_project/software project (5).png"))); // NOI18N
 ...
 jButton2.addActionListener(e -> {
        String input = JOptionPane.showInputDialog(
                this,
                "Please enter your rating from 0 to 10:",
                "Rate",
            ...
            try {
                ...
                if (rating >= 0 && rating <= 10) {
                    JOptionPane.showMessageDialog(this,
                            "Thank you! Your rating is: " + rating);
                } else {
                    JOptionPane.showMessageDialog(this,
    ...
    JOptionPane.showMessageDialog(this, "Added to your list!");
